               ...
               <div class="col-lg-9 site_information">
                  <div class="full">
                      <div class="top_section_info">
                         <ul>
                           <li>Contact Us: <img src="images/i1.png" alt="#" /> <a href="#"><?php echo($_SESSION["user_first_name"]);?></a></li>
                           <li><img src="images/i2.png" alt="#" /> <a href="#"><?php echo($_SESSION["user_email"]);?></a></li>
                           <li><img src="images/i3.png" alt="#" /> <a href="php/oAuthLogOut.php">logOut</a></li>
                        </ul>
                      </div>
                  </div>
               </div>
